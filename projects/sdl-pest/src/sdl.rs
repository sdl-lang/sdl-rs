        ...
        mod rules {
            ...
            pub mod visible {
                ...
                pub fn StringApostrophe(state: Box<::pest::ParserState<Rule>>) -> ::pest::ParseResult<Box<::pest::ParserState<Rule>>> {
                    state.atomic(::pest::Atomicity::CompoundAtomic, |state| state.rule(Rule::StringApostrophe, |state| state.sequence(|state| state.sequence(|state| self::Escape(state).and_then(|state| self::Apostrophe(state))).or_else(|state| state.restore_on_err(|state| state.sequence(|state| state.match_string("{").and_then(|state| self::expr(state)).and_then(|state| state.match_string("}"))))).or_else(|state| self::StringEscaped(state)).or_else(|state| self::NonApostrophe(state)).and_then(|state| state.repeat(|state| state.sequence(|state| self::Escape(state).and_then(|state| self::Apostrophe(state))).or_else(|state| state.restore_on_err(|state| state.sequence(|state| state.match_string("{").and_then(|state| self::expr(state)).and_then(|state| state.match_string("}"))))).or_else(|state| self::StringEscaped(state)).or_else(|state| self::NonApostrophe(state)))))))
                }
                #[inline]
                #[allow(non_snake_case, unused_variables)]
                pub fn StringQuotation(state: Box<::pest::ParserState<Rule>>) -> ::pest::ParseResult<Box<::pest::ParserState<Rule>>> {
                    state.atomic(::pest::Atomicity::CompoundAtomic, |state| state.rule(Rule::StringQuotation, |state| state.sequence(|state| state.sequence(|state| self::Escape(state).and_then(|state| self::Quotation(state))).or_else(|state| state.restore_on_err(|state| state.sequence(|state| state.match_string("{").and_then(|state| self::expr(state)).and_then(|state| state.match_string("}"))))).or_else(|state| self::StringEscaped(state)).or_else(|state| self::NonQuotation(state)).and_then(|state| state.repeat(|state| state.sequence(|state| self::Escape(state).and_then(|state| self::Quotation(state))).or_else(|state| state.restore_on_err(|state| state.sequence(|state| state.match_string("{").and_then(|state| self::expr(state)).and_then(|state| state.match_string("}"))))).or_else(|state| self::StringEscaped(state)).or_else(|state| self::NonQuotation(state)))))))
                }
                #[inline]
                #[allow(non_snake_case, unused_variables)]
                pub fn StringAcute(state: Box<::pest::ParserState<Rule>>) -> ::pest::ParseResult<Box<::pest::ParserState<Rule>>> {
                    state.atomic(::pest::Atomicity::CompoundAtomic, |state| state.rule(Rule::StringAcute, |state| state.sequence(|state| state.sequence(|state| self::Escape(state).and_then(|state| self::Acute(state))).or_else(|state| state.restore_on_err(|state| state.sequence(|state| state.match_string("{").and_then(|state| self::expr(state)).and_then(|state| state.match_string("}"))))).or_else(|state| self::StringEscaped(state)).or_else(|state| self::NonAcute(state)).and_then(|state| state.repeat(|state| state.sequence(|state| self::Escape(state).and_then(|state| self::Acute(state))).or_else(|state| state.restore_on_err(|state| state.sequence(|state| state.match_string("{").and_then(|state| self::expr(state)).and_then(|state| state.match_string("}"))))).or_else(|state| self::StringEscaped(state)).or_else(|state| self::NonAcute(state)))))))
                }
                #[inline]
                #[allow(non_snake_case, unused_variables)]
                pub fn StringQuote(state: Box<::pest::ParserState<Rule>>) -> ::pest::ParseResult<Box<::pest::ParserState<Rule>>> {
                    state.atomic(::pest::Atomicity::CompoundAtomic, |state| state.rule(Rule::StringQuote, |state| state.sequence(|state| state.sequence(|state| self::Escape(state).and_then(|state| self::Quote(state))).or_else(|state| state.restore_on_err(|state| state.sequence(|state| state.match_string("{").and_then(|state| self::expr(state)).and_then(|state| state.match_string("}"))))).or_else(|state| self::StringEscaped(state)).or_else(|state| self::NonQuote(state)).and_then(|state| state.repeat(|state| state.sequence(|state| self::Escape(state).and_then(|state| self::Quote(state))).or_else(|state| state.restore_on_err(|state| state.sequence(|state| state.match_string("{").and_then(|state| self::expr(state)).and_then(|state| state.match_string("}"))))).or_else(|state| self::StringEscaped(state)).or_else(|state| self::NonQuote(state)))))))
                }
                #[inline]
                #[allow(non_snake_case, unused_variables)]
